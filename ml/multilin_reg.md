...
##### Step 2: Matrix Form of Cost Function
...
#### Regularized Linear Regression Derivations
...
Where t(α/2,n-p-1) is the critical value from t-distribution with (n-p-1) degrees of freedom.
